...
The next product-validation milestone is a real PRD/new feature plus expression-variation evaluation. Scan correctness and retention fixes remain first-stage maintenance. Full PRD revision authority, change propagation and task/code impact tracking are deferred; do not implement that second stage solely because it appears on the roadmap. Confirmed defects may be fixed within the current authorized scope without waiting for more samples.
