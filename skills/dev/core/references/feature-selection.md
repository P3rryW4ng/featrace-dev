...
- `/dev list`: run `feature-context.py list <PROJECT>`, show IDs/titles/recorded states and any unreadable entries. Mark current only from this session's mapping. An empty list suggests creating a PRD; no files are created.
