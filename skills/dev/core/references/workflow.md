...
- Record observed effect/requirement mismatches in fixes.json and render fixes.md; route code defects, interpretation gaps, source conflicts and requirement changes under `fix-workflow.md`. Do not treat every bug as a PRD edit.
